...
/* update.twig */
class __TwigTemplate_9723d34fba4b1880246c956584d2506c015c3144f072128bb15d2ba40e488c6f extends yii\twig\Template
{
    ...
    {
        // line 1
        $context["title"] = ("Update User: " . $this->getAttribute((isset($context["model"]) ? $context["model"] : null), "username", array()));
        // line 2
...
";
        ...
        // line 8
        $context["breadcrumbs"] = twig_array_merge((isset($context["breadcrumbs"]) ? $context["breadcrumbs"] : null), array(0 => array("label" => $this->getAttribute((isset($context["model"]) ? $context["model"] : null), "username", array()), "url" => $this->env->getExtension('yii2-twig')->path("view", array("id" => $this->getAttribute((isset($context["model"]) ? $context["model"] : null), "id", array()))))));
        // line 9
...
/* {% set title = 'Update User: ' ~ model.username %}*/
...
/* {% set breadcrumbs = breadcrumbs|merge([{'label': model.username, 'url': path('view', {'id': model.id})}]) %}*/
