...
/* update.twig */
class __TwigTemplate_1c4a65d2c55d9e6b27501cd4f8dd8c1737002b206514bd41b11381d10e414a0c extends yii\twig\Template
{
    ...
    {
        // line 1
        $context["title"] = ("Update Category: " . $this->getAttribute((isset($context["model"]) ? $context["model"] : null), "name", array()));
        // line 2
...
";
        ...
        // line 8
        $context["breadcrumbs"] = twig_array_merge((isset($context["breadcrumbs"]) ? $context["breadcrumbs"] : null), array(0 => array("label" => $this->getAttribute((isset($context["model"]) ? $context["model"] : null), "name", array()), "url" => $this->env->getExtension('yii2-twig')->path("view", array("id" => $this->getAttribute((isset($context["model"]) ? $context["model"] : null), "id", array()))))));
        // line 9
...
/* {% set title = 'Update Category: ' ~ model.name %}*/
