...
/* update.twig */
class __TwigTemplate_acaf2cbd8a7dd9cdb6be8416e476b00f7221af73f0dc2ff1eb81652d574d422f extends yii\twig\Template
{
    ...
    {
        // line 1
        $context["title"] = ("Update Stopword: " . $this->getAttribute((isset($context["model"]) ? $context["model"] : null), "word", array()));
        // line 2
...
";
        ...
        // line 8
        $context["breadcrumbs"] = twig_array_merge((isset($context["breadcrumbs"]) ? $context["breadcrumbs"] : null), array(0 => array("label" => $this->getAttribute((isset($context["model"]) ? $context["model"] : null), "word", array()), "url" => $this->env->getExtension('yii2-twig')->path("view", array("id" => $this->getAttribute((isset($context["model"]) ? $context["model"] : null), "id", array()))))));
        // line 9
...
/* {% set title = 'Update Stopword: ' ~ model.word %}*/
...
/* {% set breadcrumbs = breadcrumbs|merge([{'label': model.word, 'url': path('view', {'id': model.id})}]) %}*/
